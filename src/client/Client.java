...
public class Client {
    ...
    public Client(String user) throws IOException {
        ...
        socket = new Socket(Controller.ip, Controller.port - 1);
        ...
        voiceSocket = new Socket(Controller.ip, Controller.port - 2);
    ...
    public class voiceChatHandler extends Thread {
        DataInputStream in;
        DataOutputStream out;

        voiceChatHandler(DataInputStream in, DataOutputStream out) {
            this.in = in;
            this.out = out;
            start();
        }
